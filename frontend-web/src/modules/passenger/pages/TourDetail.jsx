...
//   Users,
// } from "lucide-react";
// import passengerCatalogService from "../services/passengerBookingService";
...
//   if (loading)
//     return (
//       <div className="catalog-state full-page">Đang tải hành trình...</div>
//     );
//   if (error || !tour) {
//     return (
...
//           <Link className="back-link" to="/passenger/dashboard">
//             <ArrowLeft size={18} /> Tất cả tour
//           </Link>
//           <span className="eyebrow">{tour.code}</span>
//           <h1>{tour.name}</h1>
//           <p>
//             <Ship size={19} /> {tour.cruiseName}
//           </p>
//         </div>
//       </section>
...
//                 <Users />
//                 <span>
//                   <small>Sức chứa tàu</small>
//                   {tour.maxPassengers} hành khách
//                 </span>
//               </div>
//             </div>
//           </article>
...
//               Giá hiển thị là giá của loại phòng cho chuyến đã chọn.
//             </p>
...
//                       <strong>
//                         {room.roomTypeName} · Phòng {room.roomCode}
//                       </strong>
//                       <small>
//                         Tầng {room.deckNumber} · Còn {room.remainingCapacity}/
//                         {room.capacity} chỗ
//                       </small>
//                     </span>
...
//                   Chuyến này hiện không còn phòng trống.
//                 </div>
//               )}
//             </div>
//           </article>
...
//             <MapPin size={18} /> {tour.cruiseName}
//           </div>
//           <div className="summary-row">
//             <CalendarDays size={18} /> {formatDate(departure?.departureDate)}
//           </div>
//           <div className="summary-divider" />
//           <p>
//             {selectedRoomId
//               ? "Phòng đã được chọn. Bạn có thể sang bước tạo booking."
//               : "Vui lòng chọn một phòng còn trống."}
//           </p>
...
//             </Link>
//           ) : (
//             <button className="booking-button" disabled type="button">
//               Tiếp tục đặt tour
//             </button>
//           )}
//           <small>
//             Thông tin và giá phòng sẽ được xác nhận lại trước khi tạo booking.
//           </small>
//         </aside>
//       </section>
//     </main>
