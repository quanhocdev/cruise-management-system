...
// @Column(nullable = false, unique = true, length = 64) private String
// fingerprint;
// @Column(nullable = false, length = 3) private String scanType;
// @ManyToOne(fetch = FetchType.LAZY, optional = false)
// @JoinColumn(name = "passenger_voyage_id", nullable = false) private
// PassengerVoyage passengerVoyage;
...
// public void setPassengerVoyage(PassengerVoyage value) { passengerVoyage =
// value; }
