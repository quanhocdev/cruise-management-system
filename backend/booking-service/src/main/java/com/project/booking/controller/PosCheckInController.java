...
// @GetMapping("/lookup")
// public ResponseEntity<CheckInLookupResponse> lookupBooking(@RequestParam
// String code) {
// return ResponseEntity.ok(checkInService.lookupByCode(code));
// }

// @PostMapping("/confirm")
// public ResponseEntity<?> confirmCheckIn(@Valid @RequestBody
// ConfirmCheckInRequest request) {
// checkInService.confirmCheckIn(request);
// return ResponseEntity.ok(Map.of("message", "Check-in và gán phòng thành
// công"));
// }
// }