...
// this.service = service; this.expectedKey =
// key.getBytes(StandardCharsets.UTF_8);
// }
// @GetMapping("/{id}/payment-context")
// BookingPaymentContext context(@PathVariable Long id, @RequestHeader(value =
// "X-Internal-Api-Key", required = false) String key) {
// authorize(key); return service.getPaymentContext(id);
// }
// @PutMapping("/{id}/payment-confirmation")
// BookingResponse confirm(@PathVariable Long id, @Valid @RequestBody
...
// FeedbackEligibilityResponse feedbackEligibility(@PathVariable Long id,
...
// throw new BookingException(HttpStatus.UNAUTHORIZED, "Invalid internal API
// key");
// }
// }
