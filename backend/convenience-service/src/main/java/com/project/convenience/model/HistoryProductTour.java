...
@Entity
@Table(name = "history_product_tour", uniqueConstraints = {
        @UniqueConstraint(name = "uk_history_product_tour_tour_id", columnNames = "tour_id")
})
public class HistoryProductTour {
    ...
    /*
     * Tour đã hoàn thành cấu hình Product Tour.
     *
    ...
    /*
     * Tổng số ProductTour đã được cấu hình
