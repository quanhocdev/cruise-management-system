...
//     public CookieOrHeaderBearerTokenConverter(ServerBearerTokenAuthenticationConverter headerConverter) {
...
//                 .switchIfEmpty(Mono.defer(() -> tokenFromCookie(exchange)));
//     }

//     private Mono<Authentication> tokenFromCookie(ServerWebExchange exchange) {
