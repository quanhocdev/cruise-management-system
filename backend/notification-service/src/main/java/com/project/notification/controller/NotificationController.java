...
import com.project.notification.service.TestNotificationService;
...
public class NotificationController {
    private final TestNotificationService service;

    public NotificationController(TestNotificationService service) {
    ...
    NotificationResponse markRead(@PathVariable Long id, @AuthenticationPrincipal Jwt jwt) {
    ...
    private Long userId(Jwt jwt) {
        ...
        try {
            ...
            throw new NotificationException(HttpStatus.BAD_REQUEST, "JWT userId claim is missing or invalid");
        }
    }
}
