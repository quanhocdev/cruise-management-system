...
public class PortCallController {
    ...
    public PortCallController(PortCallService service) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<PortCallResponse> get(@PathVariable UUID scheduleId, @PathVariable UUID dayId,
    ...
    public ResponseEntity<PortCallResponse> cancel(@PathVariable UUID scheduleId, @PathVariable UUID dayId,
            @PathVariable UUID id) {
