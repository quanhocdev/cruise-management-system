...
public class ActivityCruiseService {
     ...
     * =====================================================
     */
    public ActivityCruiseResponse createActivity(
            CreateActivityCruiseRequest request) {
    ...
    public ActivityCruiseResponse updateActivity(
        ...
        ActivityCruiseMapper.updateEntity(
                activity,
                request);
        ...
        return ActivityCruiseMapper.toResponse(
                updatedActivity);
    }
    ...
    public void deleteActivity(UUID id) {
        ...
        if (activity.getImagePublicId() != null
                && !activity.getImagePublicId().isBlank()) {

            fileStorageService.delete(
                    activity.getImagePublicId());
        }
