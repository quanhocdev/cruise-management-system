...
public class ActivitiesCruiseController {
    ...
    public ActivitiesCruiseController(
            ActivityCruiseService activityCruiseService) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ActivityCruiseResponse> getActivityById(
            @PathVariable UUID id) {

        return ResponseEntity.ok(
                activityCruiseService.getActivityById(id));
    }
    ...
    public ResponseEntity<List<ActivityCruiseResponse>> getActivities() {
        ...
        return ResponseEntity.ok(
                activityCruiseService.getActivities());
    }
    ...
    public ResponseEntity<List<ActivityCruiseResponse>> getActiveActivities() {
        ...
        return ResponseEntity.ok(
                activityCruiseService.getActiveActivities());
    }
    ...
    public ResponseEntity<ActivityCruiseResponse> updateActivity(
        ...
        return ResponseEntity.ok(
                activityCruiseService.updateActivity(id, request));
    }
