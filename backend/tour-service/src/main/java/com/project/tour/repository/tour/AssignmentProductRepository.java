...
// @Repository
// public interface AssignmentProductRepository extends
// JpaRepository<AssignmentProduct, UUID> {
...
// Optional<AssignmentProduct> findByTourIdAndCruiseAreaId(UUID tourId, UUID
// cruiseAreaId);

// boolean existsByTourIdAndCruiseAreaId(UUID tourId, UUID cruiseAreaId);

// @Modifying
// @Query("DELETE FROM AssignmentProduct a WHERE a.tourId = :tourId AND
