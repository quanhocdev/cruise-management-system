...
public class CruiseDeckController {
    ...
    public ResponseEntity<CruiseDeckResponse> createCruiseDeck(
        ...
        CruiseDeckResponse response = cruiseDeckService.createCruiseDeck(
                cruiseId,
                request);
    ...
    public ResponseEntity<List<CruiseDeckResponse>> getCruiseDecks(
        ...
        if (activeOnly) {
            response = cruiseDeckService.getActiveCruiseDecks(cruiseId);
        } else {
            response = cruiseDeckService.getCruiseDecks(cruiseId);
        }
    ...
    public ResponseEntity<CruiseDeckResponse> getCruiseDeckById(
        ...
        CruiseDeckResponse response = cruiseDeckService.getCruiseDeckById(
                cruiseId,
                deckId);
    ...
    public ResponseEntity<CruiseDeckResponse> updateCruiseDeck(
        ...
        CruiseDeckResponse response = cruiseDeckService.updateCruiseDeck(
                cruiseId,
                deckId,
                request);
    ...
    public ResponseEntity<CruiseDeckResponse> deactivateCruiseDeck(
            @PathVariable UUID cruiseId,
            @PathVariable UUID deckId) {
        CruiseDeckResponse response = cruiseDeckService.deactivateCruiseDeck(
                cruiseId,
                deckId);
