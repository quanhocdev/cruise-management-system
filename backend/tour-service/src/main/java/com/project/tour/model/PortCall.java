...
@Table(name = "port_calls", uniqueConstraints = @UniqueConstraint(
    name = "uk_port_calls_day_port", columnNames = {"itinerary_day_id", "port_id"}
))
public class PortCall {
    ...
    public void setPlannedArrivalTime(LocalDateTime value) { this.plannedArrivalTime = value; }
    public LocalDateTime getActualArrivalTime() { return actualArrivalTime; }
    public void setActualArrivalTime(LocalDateTime value) { this.actualArrivalTime = value; }
    public LocalDateTime getPlannedDepartureTime() { return plannedDepartureTime; }
    public void setPlannedDepartureTime(LocalDateTime value) { this.plannedDepartureTime = value; }
    public LocalDateTime getActualDepartureTime() { return actualDepartureTime; }
    public void setActualDepartureTime(LocalDateTime value) { this.actualDepartureTime = value; }
    public LocalDateTime getReturnDeadline() { return returnDeadline; }
    public void setReturnDeadline(LocalDateTime value) { this.returnDeadline = value; }
