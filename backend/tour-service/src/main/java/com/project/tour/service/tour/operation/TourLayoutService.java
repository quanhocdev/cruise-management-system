        ...
        return decks.stream()
                .map(deck -> {
                    List<CruiseArea> areas = cruiseAreaRepository
                            .findAllByCruiseDeck_IdAndStatusOrderByNameAsc(deck.getId(), CruiseAreaStatus.ACTIVE);

                    List<Room> rooms = roomRepository
                            .findAllByCruiseDeck_IdAndStatusOrderByCodeAsc(deck.getId(), RoomStatus.ACTIVE);
